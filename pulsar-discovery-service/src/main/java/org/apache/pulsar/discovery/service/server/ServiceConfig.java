...
public class ServiceConfig implements PulsarConfiguration {
    ...
    // TLS KeyStore type configuration in broker: PEM, JKS, PKCS12
    private String tlsKeyStoreType = "JKS";
    // TLS KeyStore path in broker
    private String tlsKeyStore = null;
    // TLS KeyStore password path in broker
    private String tlsKeyStorePasswordPath = null;
    // TLS TrustStore type configuration in broker: PEM, JKS, PKCS12
    private String tlsTrustStoreType = "JKS";
    // TLS TrustStore path in broker
    private String tlsTrustStore = null;
    // TLS TrustStore password path in broker"
